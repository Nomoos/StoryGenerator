...
def main():
    ...
    parser.add_argument(
        "--gender", type=str, choices=["women", "men"], help="Target gender segment"
    )
    parser.add_argument("--age", type=str, help="Target age bucket (e.g., '18-23', '24-29')")
    parser.add_argument("--all-segments", action="store_true", help="Run pipeline for all segments")
    parser.add_argument(
        "--output", type=Path, default=Path("data"), help="Base output directory (default: data)"
    )
    parser.add_argument(
        "--ideas-count", type=int, default=20, help="Number of LLM ideas to generate (default: 20)"
    )
    parser.add_argument(
        "--titles-per-topic",
        type=int,
    ...
    parser.add_argument(
        "--top-n", type=int, default=5, help="Number of top titles to select (default: 5)"
    )
