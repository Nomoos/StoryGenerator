...
def check_single_video(video_path: str, title_id: str = None, save_report: bool = True, output_dir: str = None):
    """
...
Examples:
  ...
  python scripts/check_video_quality.py video.mp4 --no-save
    ...
    parser.add_argument(
        '--title-id',
        dest='title_id',
        help='Title ID for the QC report (for single video only)'
    )
    ...
    parser.add_argument(
        ...
        dest='save_report',
        action='store_false',
        help='Do not save QC report to file'
    )
