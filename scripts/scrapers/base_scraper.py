...
class BaseScraper(ABC):
    ...
    def filter_age_appropriate(self, content_items: List[Dict], age_bucket: str) -> List[Dict]:
    ...
    def save_content(self, content_items: List[Dict], gender: str, age_bucket: str) -> Path:
    ...
    def run(self, topic: str, gender: str, age_bucket: str, limit: int = 50) -> Dict:
