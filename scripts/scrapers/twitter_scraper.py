...
class TwitterScraper(BaseScraper):
    ...
    def _get_search_queries(self, topic: str, gender: str, age_bucket: str) -> List[str]:
        ...
        base_queries = {
            "10-13": ["thread about school life", "teenage story thread", "friendship thread"],
            "14-17": [
                "high school story thread",
                "teenage experience thread",
                "life lesson thread",
            ],
            "18-23": ["college story thread", "relationship thread", "life advice thread"],
        }
    ...
    def _is_story_thread(self, thread: Dict) -> bool:
        ...
        story_indicators = ["thread", "story", "let me tell you", "🧵", "here's what happened"]
...
def main():
    ...
    topics = {"10-13": "teenage experiences", "14-17": "high school life", "18-23": "young adult"}
